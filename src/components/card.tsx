                    ...
                    <div key={`nft${idx}`} className='container bg-transparent  w-[292px] h-[440px]'>
                        <div className='block w-full h-full'>
                            <div className="flex items-end w-full h-full relative">
                                <div className='map'>
                                    <div className='hello'>
                                        <div className='maincir'>
                                            <div className={`icon absolute top-[-2px] left-[8.2px]  h-[103px] w-[103px] rounded-full brand-logo ${item?.logoshadow}`}>
                                        ...
                                        <div className='first-cir'></div>
                                        <div className='sec-cir'></div>
                                        <div className="w-full h-[22.1rem] relative">
